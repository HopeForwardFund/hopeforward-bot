...
TEXTS = {
    'en': {
        ...
        'custom_ask': "💬 Enter your amount in dollars (e.g. 15):",
        'pay': "💛 Donate ${} Now",
        'thanks': "🙏 *Thank you for your kindness!*\n\nYour ${} donation will make a real difference.\n\n*Together, we can make a difference* ❤️",
        'impact': {
            5: "🍽️ Feeds a child for a day",
            10: "📚 School supplies",
            25: "💊 Week of medicine",
            50: "🧥 Winter clothing",
            100: "📦 Emergency food kit",
            250: "🌟 Month of support"
        },
    ...
    'ru': {
        ...
        'impact': {
            5: "🍽️ Еда для ребёнка на день",
            10: "📚 Школьные принадлежности",
            25: "💊 Лекарства на неделю",
            50: "🧥 Зимняя одежда",
            100: "📦 Набор продуктов",
            250: "🌟 Месяц поддержки"
        },
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lang_"):
        ...
        keyboard.append([InlineKeyboardButton("◀️ Back", callback_data=f"lang_{lang}")])
        ...
        await context.bot.send_invoice(
            ...
            description=t['impact'].get(amount, f"Donation of ${amount}"),
            payload=f"donate_{amount}",
            currency="XTR",  # Telegram Stars
            prices=[LabeledPrice(label=f"Donation ${amount}", amount=amount)],
        )
...
def main():
    ...
    print("✅ HopeForward Bot is running!")
    app.run_polling()
